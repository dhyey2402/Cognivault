            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-4">
                <label className="flex items-center gap-3 cursor-pointer group">
                  <div className={`w-6 h-6 rounded flex items-center justify-center border transition-colors ${settings.alertLowScores ? 'bg-indigo-500 border-indigo-500' : 'bg-slate-800 border-slate-700 group-hover:border-slate-500'}`}>
                ...
                <label className="flex items-center gap-3 cursor-pointer group">
                  <div className={`w-6 h-6 rounded flex items-center justify-center border transition-colors ${settings.alertNewRegistrations ? 'bg-indigo-500 border-indigo-500' : 'bg-slate-800 border-slate-700 group-hover:border-slate-500'}`}>
